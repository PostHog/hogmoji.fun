...
export function EditorPage() {
  ...
  if (!template) {
    return (
      <div className="flex flex-col items-center justify-center flex-grow px-4">
        ...
        <Link to="/" className="text-hog-500 hover:underline">
          Back to templates
        </Link>
      </div>
    );
  ...
  return (
    <>
      <SEO
        title={`${template.name} - create custom hogmoji`}
        description={`Use the ${template.name} template to create your own custom PostHog hedgehog emoji. Design, customize, and export your perfect hogmoji.`}
        keywords="hogmoji, posthog, hedgehog, builder, create, custom, emoji, design, editor"
        url={`https://hogmoji.fun/${id}`}
      />
              ...
              return (
                <label
                  ...
                  className={`w-14 h-14 rounded-lg shadow-lg flex items-center justify-center transition-all cursor-pointer ${
                    isActive
                      ? "bg-hog-200 ring-2 ring-hog-300"
                ...
                >
                  <div className="w-10 h-10 flex items-center justify-center overflow-hidden rounded">
                    <svg
                      className="w-6 h-6 text-hog-400"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                ...
                >
                  <div className="w-10 h-10 flex items-center justify-center overflow-hidden rounded">
                    {imgSrc ? (
                      ...
                      <svg
                        className={`w-6 h-6 ${isActive ? "text-hog-600" : "text-gray-400"}`}
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
        ...
        >
          {layers.map((layer, idx) => {
            ...
            return (
              <div
                key={layer.id}
                className={`absolute cursor-move ${isActive ? "ring-1 ring-hog-500" : ""}`}
                style={{
              ...
              >
                ...
                {isActive && (
                  <>
                    ...
                    >
                      <div className="bg-white border-2 border-hog-500 rounded-sm" style={{ width: 8, height: 8 }} />
                    </div>
                    <div
        ...
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
          <div className="bg-white rounded-xl shadow-2xl max-w-md w-full mx-4 overflow-hidden">
            <div className="p-4 border-b border-gray-200 flex items-center justify-between">
              <h2 className="text-lg font-semibold text-gray-800">Save your hogmoji</h2>
              <button
            ...
            <div className="p-4">
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-hog-500 focus:border-hog-500 outline-none"
                  placeholder="hog-custom"
                />
              </div>
